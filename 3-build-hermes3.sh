...
cmake . -B $BUILD_NAME -DCMAKE_BUILD_TYPE=Release -DCMAKE_PREFIX_PATH="${BOUT_DIR}/BOUT-dev/build" -DHERMES_BUILD_BOUT=False -DHERMES_SLOPE_LIMITER=MinMod -DCMAKE_CXX_COMPILER=CC
cd $BUILD_NAME
make -j 8
cd ..
